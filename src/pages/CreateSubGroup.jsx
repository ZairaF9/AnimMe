...
const CreateSubGroupo = () => 
{
    ...
    const handleSubmit = async (e) => {
        ...
        querySnapshot.forEach((doc) => {
            ...
            UsersGroupuid = doc.data().usersId;
            UsersGroupName = doc.data().usersName;
        });
            ...
            uploadTask.on(
                ...
                () => {
                    getDownloadURL(uploadTask.snapshot.ref).then(async (downloadURL) => {
                        await setDoc(doc(db, "SubGroupsChat", Gruopuuid), {
                            uid: Gruopuuid,
                            Messages: Messages
                        });
                        await setDoc(doc(db, "SubGroups", Gruopuuid), {
                            uid: Gruopuuid,
                            NameGroup,
                            Grupo: params.uid,
...
export default CreateSubGroupo