...
import VideoLlamada from "./pages/VideoChat";
import VideoLlamadaGrupal from "./pages/VideoChatsGrupal";
...
return children
  ...
  <Routes>
    <Route path="/">
      ...
      <Route path="videoChat" element={<VideoLlamada/>}/>
      <Route path="videoChatGrupal/:uid" element={<VideoLlamadaGrupal/>}/>
    </Route>
  </Routes>
  </BrowserRouter>
  );
