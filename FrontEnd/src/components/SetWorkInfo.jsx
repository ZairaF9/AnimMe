...
const SetWorkInfo = ({ message }) => {
    ...
    return (
        ...
        <div class="Content_Tarea">
                ...
                <input type="file" name="" id="fileTarea" class="File_Tarea" onChange={EnviarTarea(this)}/>
                <label for="fileTarea" className="File_Tarea_Label">Subir Tarea</label><br/><br/>
